...
AUTO_DELETE_MSG = os.environ.get("AUTO_DELETE_MSG", "⚠️ <b>Warning<b> ⚠️ \n<b>This file will be automatically deleted in 10 minutes.<b> \n📌<b>Please forward and save this content somwhere else before start downloading.<b>")
